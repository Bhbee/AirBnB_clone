...
Acknowledgements
## Description 📄
This team project is part of the ALX School Full-Stack Software Engineer program. It's the first step towards building a first full web application: an AirBnB clone.
...
# Authors 🖋️
Boluwatife Adetayo @Bhbee
Solomon Adegboyega @Solomonade1
